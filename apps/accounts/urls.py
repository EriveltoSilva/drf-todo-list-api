...
urlpatterns = [
    ...
    path('users/<uuid:id>/', views.UserRetrieveUpdateDestroyAPIView.as_view(), name='user-retrieve-update-delete'),

    # ! Create, Read, Update, Delete
    # Profile endpoints
    path('profiles/', views.ProfileListAPIView.as_view(), name='profile-list'),
    path('profiles/<uuid:id>/', views.ProfileRetrieveUpdateView.as_view(), name='profile-retrieve-update'),
]
